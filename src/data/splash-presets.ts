...
const presets: SplashPreset[] = [
  ...
  { id:14, name:'Grid Lines', bg:'#040406', mesh:'', particles:'grid', titleGradient:'#f5f5f7', titleShadow:'none', logoStyle:{border:'1px solid #333'}, codeTheme:{bg:'rgba(6,6,8,.95)','border-color':'#222'}, accentColor:'#f5f5f7', accentColor2:'#777', textGlow:'none', exitEffect:'grid', noiseOpacity:.002, particleCount:0, particleColors:[], geoCount:0, geoShapes:[], ctaGradient:'#222', ctaGlow:'none', progressGradient:'linear-gradient(90deg,#444,#888)' },
